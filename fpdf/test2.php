...
class PDFWithWatermark extends FPDF
{
    ...
    function setWatermarkOrientation($orientation)
    {
    ...
    function Header()
    {
        if ($this->watermark) {
            ...
            if ($this->orientation == 'horizontal') {
                $this->Image($this->watermark, 10, $this->GetPageHeight() / 2 - $newHeight / 2, $this->GetPageWidth() - 20);
            } elseif ($this->orientation == 'vertical') {
                $this->Image($this->watermark, $this->GetPageWidth() / 2 - $newWidth / 2, 10, 0, $this->GetPageHeight() - 20);
            } elseif ($this->orientation == 'diagonal') {
...
$pdf->setWatermarkOrientation('vertical');
